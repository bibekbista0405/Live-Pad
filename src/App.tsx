  ...
  const handleNavigateRoom = async (roomId: string | null): Promise<boolean> => {
    ...
    if (isFirebaseConfigured && db) {
      try {
        ...
        addToast('error', 'Unable to verify workspace connection. Please check your network connection.');
        return false;
      }
    }
      ...
      <AnimatePresence mode="wait">
        {isDesktopApp && !roomCode && !activeLocalNoteId ? (
          ...
          >
            ...
            <div className="w-full pt-12 border-t border-slate-300/20 dark:border-zinc-800/20">
